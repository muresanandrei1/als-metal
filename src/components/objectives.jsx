...
export default function Objectives() {
  ...
  return (
    <section id="about">
      <div class="mx-auto mt-20 mb-20 max-w-7xl px-6 lg:px-8">
        <div class="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
          ...
          <dl class="mt-16 grid grid-cols-1 gap-x-8 gap-y-12 sm:mt-20 sm:grid-cols-2 sm:gap-y-16 lg:mt-28 lg:grid-cols-4">
            <div class="flex flex-col-reverse gap-y-3 border-l border-slate-400 pl-6 justify-end">
              <dt class="text-base leading-7">
                {t("objectivesSection.item1")}
              </dt>
              <dd class="text-3xl text-slate-500 font-semibold tracking-tight">
                1
              </dd>
            </div>
            <div class="flex flex-col-reverse gap-y-3 border-l border-slate-400 pl-6 justify-end">
