  ...
  return (
    <section id="yellow">
      <div className="relative isolate overflow-hidden mb-24 h-[500px] lg:h-[420px] relative flex">
        ...
        <div className="mx-auto mt-10 max-w-7xl px-6 lg:px-8 flex flex-col lg:flex-row justify-end relative z-2 align-center lg:mt-auto lg:ml-auto lg:mr-[100px] gap-10 mb-12">
          <img src={cogs} className="h-auto max-w-[200px] mx-auto" />
